...
,KC_TRNS ,KC_PERC     ,KC_CIRC      ,KC_LBRC ,KC_RBRC ,KC_TILD ,KC_UP
,KC_SCLN ,KC_AMPR     ,KC_ASTR ,LSFT(KC_COMM),LSFT(KC_DOT)
                                             ...
                                             ,KC_PLUS ,KC_EQL  ,M(NotEq)
                                                                 ...
                                                                 ,KC_DOWN     ,KC_BSLS     ,KC_1  ,KC_2   ,KC_3  ,KC_MINS ,KC_TRNS
 ...
 * `------+---------+---------+---------+---------+----------------'    `----------------+---------+---------+---------+---------+------'
 *  | ||| |  ||||   |  MClick |  RClick |  LClick |                                      |  Insert |   Del   |   ||||  |  ||||   | ||| |
 *  `---------------------------------------------'                                      `---------------------------------------------'
 *                                                   ,-------------.    ,-------------.
...
,KC_NO ,KC_NO   ,KC_BTN3 ,KC_BTN2  ,KC_BTN1
                                      ...
                                      ,KC_WBAK ,KC_NO   ,KC_WHOM
                                                                     ...
                                                                     ,KC_WH_U  ,KC_TRNS ,KC_HOME      ,KC_UP        ,KC_PGUP ,KC_TRNS ,KC_TRNS
                                                                               ,KC_LEFT ,KC_LEFT      ,KC_DOWN      ,KC_RIGHT,KC_RIGHT ,KC_TRNS
