 ...
 * `-----------------------+------+------+------+-------+------|  |------+------+-------+------+------+------------------------'
 *                         |      | LGUI | Bksp |Esc/SYM|      |  |      | Ctrl |Spc/NAV| AltGr|      |
 *                         `-----------------------------------'  `-----------------------------------'
 */
    [_QWERTY] = LAYOUT(
     PAREN  , KC_Q ,  KC_W   ,  KC_E  ,   KC_R ,   KC_T ,                                        KC_Y  ,   KC_U ,  KC_I ,   KC_O ,  KC_P  , _______,
     KC_GRV , A_SFT,  KC_S   ,  KC_D  ,   KC_F ,   KC_G ,                                        KC_H  ,   KC_J ,  KC_K ,   KC_L ,SCLN_SFT,CTL_QUOT,
     KC_TAB , KC_Z ,  KC_X   ,  KC_C  ,   KC_V ,   KC_B , KC_LBRC,KC_BSLS,     _______, KC_RBRC, KC_N  ,   KC_M ,KC_COMM, KC_DOT ,SLSH_NUM, KC_ENT ,
                               _______, KC_LGUI, KC_BSPC, ESC_SYM,_______,     _______, KC_LCTL,SPC_NAV, KC_RALT, _______
    ),
 ...
 */
    [_NAV] = LAYOUT(
      _______, _______, _______, _______, _______, _______,                                     KC_PGUP, KC_HOME, KC_END , _______, KC_VOLU, KC_DEL,
      _______, _______, _______, _______, _______, _______,                                     KC_LEFT, KC_DOWN, KC_UP  , KC_RGHT, KC_VOLD, KC_INS,
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_PGDN, KC_MPRV, KC_MPLY, KC_MNXT,KC_PAUSE,_______,
 ...
 */
    [_SYM] = LAYOUT(
     _______, _______, _______, _______, _______, _______,                                LSFT(KC_MINS),   KC_7 , KC_8 , KC_9 ,   KC_0 , KC_EQL ,
     _______, _______, _______, _______, _______, _______,                                      KC_PEQL,   KC_4 , KC_5 , KC_6 , _______, KC_PLUS,
     _______, _______, _______, _______, _______, _______, TPREV  , BBACK  ,  BFORW  , TNEXT  , KC_MINS,   KC_1 , KC_2 , KC_3 , KC_TRNS, _______,
                                _______, _______, _______, _______, _______,  _______, _______, _______, _______, _______
    ),
