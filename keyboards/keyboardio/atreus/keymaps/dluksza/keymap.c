...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LW] = LAYOUT( /* [> LOWER <] */
    ...
    BRIDN,   KC_VOLU, BRIUP,   KC_NO,   QK_BOOT, BBACK, BFORW, KC_NO,   KC_F1,   KC_F2,   KC_F3,   KC_F12  ,
    KC_NO,   KC_VOLD, KC_LGUI, KC_LSFT, KC_BSPC, TPREV, TNEXT, KC_SPC,  KC_NO,   KC_PSCR, KC_SCRL, KC_PAUS )
};
